...
// Verificar si 'salida' es nulo antes de imprimir
if ($datos_reporte->salida !== null) {
   $pdf->Cell(50, 10, utf8_decode(date('d/m/Y H:i:s', strtotime($datos_reporte->salida))), 1, 1, 'C', 0);
} else {
   $pdf->Cell(50, 10, utf8_decode('N/A'), 1, 1, 'C', 0); // Puedes imprimir 'N/A' o cualquier otro mensaje para indicar que no hay valor
}
   }
